...
use windows::Win32::UI::WindowsAndMessaging::{
    ...
    RegisterClassA, SetWindowsHookExA, TranslateMessage, UnhookWindowsHookEx, CS_HREDRAW, CS_OWNDC,
    CS_VREDRAW, HCURSOR, HHOOK, IDC_ARROW, MSG, WH_KEYBOARD_LL, WINDOW_EX_STYLE, WINDOW_STYLE,
    WM_DESTROY, WM_NULL, WM_PAINT, WNDCLASSA,
};
...
pub fn set_keyboard_hook() -> HHOOK {
    return handle_result(unsafe {
        SetWindowsHookExA(WH_KEYBOARD_LL, Some(callback), HINSTANCE(0), 0)
    });
}
